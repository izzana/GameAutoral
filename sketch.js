...
function draw() {
  ...
  if(gameState == "lost"){
    ...
    player.destroy();
  } else if(gameState == "won"){ //destrua o zumbi e o jogador e exiba uma mensagem no gameState "won" (ganhou)
    textSize(100)
    fill("yellow")
  ...
  } else if(gameState == "bullet"){//destruir o zumbi, jogador e balas e exibir uma mensagem no gameState "bala"
    textSize(50)
    fill("yellow")
